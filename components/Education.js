          ...
          >
            <div className="text-center mb-8">
              ...
              <div className="flex flex-col items-center space-y-4 mb-8">
                ...
                <div className="w-full max-w-xs bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                  <div className="bg-gradient-to-r from-blue-600 to-cyan-500 h-full rounded-full" style={{ width: '90%' }} />
                </div>
            ...
            <div className="mt-8">
              <h4 className="text-xl font-medium text-gray-700 dark:text-gray-200 mb-6 text-center flex items-center justify-center gap-2">
                <FiBookOpen className="text-xl" /> Relevant Courses
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {courses.map((course, i) => (
                  <CourseItem key={i} {...course} />
                ))}
              </div>
            </div>
          </motion.div>
